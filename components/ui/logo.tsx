      ...
      <div className="relative">
        {isRTL ? (
          <div className="flex items-center font-bold">
            <span className="text-primary-500 font-heading tracking-tight">
              <span className={`${sizeClasses[size]} font-extrabold`}>טאבו</span>
              <span className={`${sizeClasses[size]} font-light ml-1`}>ישראל</span>
            </span>
          ...
          <div className="flex items-center font-bold">
            <span className="text-primary-500 font-heading tracking-tight">
              ...
              <span className={`${sizeClasses[size]} font-light ml-1`}>Israel</span>
            </span>
            <div className="absolute -bottom-1 left-0 right-0 h-0.5 bg-gradient-to-r from-primary-600 to-primary-400 rounded-full"></div>
          </div>
        )}
